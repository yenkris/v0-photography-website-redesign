      ...
      <div className="container mx-auto px-4 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
          ...
          <p className="text-lg text-muted-foreground text-balance leading-relaxed">
            Ready to book your session? Get in touch and let's discuss how we can capture your special moments.
          </p>
        </div>
              ...
              <CardContent className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <a href="mailto:hello@cypictures.com" className="text-sm text-muted-foreground hover:text-accent">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <a href="tel:+1234567890" className="text-sm text-muted-foreground hover:text-accent">
                      (123) 456-7890
                    </a>
                  </div>
                </div>
